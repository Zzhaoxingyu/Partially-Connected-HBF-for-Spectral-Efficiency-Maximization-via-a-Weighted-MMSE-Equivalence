function rate = WMMSE_EI_Ite_wbmethod(Nt,Nr,Nt_rf,Nr_rf,Vn,Ns,H,Nk,frf_ini,wrf_ini,ifVFD,ini_F_RF,ini_W_RF,ini_W_D,ini_F_D,fd_ini,Iter_max)
% =========================================================
