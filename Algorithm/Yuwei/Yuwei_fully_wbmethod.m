function [rate]  = Yuwei_fully_wbmethod(Nt,Nr,Nt_rf,Nr_rf,Vn,Ns,H,Nk,frf_ini,wrf_ini)

V_RF = yuwei_fullyA1(Nt,Nt_rf,Vn,H,Nk,frf_ini);
Q = (V_RF'*V_RF); 
T = Q^(-0.5);
...
W_RF  = yuwei_fullyA2(V_D,V_RF,Nr,Nr_rf,H,Vn,Nk,wrf_ini); 
for k = 1:Nk
